        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Adres_City = table.Column<string>(type: "TEXT", nullable: false),
                    Adres_Street = table.Column<string>(type: "TEXT", nullable: false),
                    Adres_PostalCode = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
